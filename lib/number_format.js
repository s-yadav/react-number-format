...
function limitToPrecision(numStr, precision, fillDecimalZeroes) {
  var str = '';
  var filler = fillDecimalZeroes ? '0' : '';
...
function roundToPrecision(numStr, precision, fillDecimalZeroes) {
  ...
  var hasDecimalSeperator = numStr.indexOf('.') >= 0;
  var currentDecimalPart = numberParts[1] || '';
  var roundedDecimalParts = currentDecimalPart.length > precision || fillDecimalZeroes ? parseFloat('0.' + (currentDecimalPart || '0')).toFixed(precision).split('.') : ['0', currentDecimalPart];
...
var propTypes = {
  ...
  fillDecimalZeroes: _propTypes2.default.bool
};
...
var NumberFormat = function (_React$Component) {
  ...
  _createClass(NumberFormat, [{
    ...
    value: function optimizeValueProp(props) {
      ...
      var numberParts = value.split(decimalSeparator);
    ...
    value: function formatInput(val) {
      ...
      var prefix = props.prefix,
          ...
          fillDecimalZeroes = props.fillDecimalZeroes;
      ...
      if (format) {
        ...
        var hasDecimalSeparator = formattedValue.indexOf(decimalSeparator) !== -1 || decimalPrecision && fillDecimalZeroes;
    ...
    value: function onKeyDown(e) {
      ...
      var _props6 = this.props,
          ...
          fillDecimalZeroes = _props6.fillDecimalZeroes;
      var key = e.key;

      var numRegex = this.getNumberRegex(false, decimalPrecision !== undefined && fillDecimalZeroes);
      var negativeRegex = new RegExp('-');
