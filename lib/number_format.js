...
var propTypes = {
  thousandSeparator: _propTypes['default'].oneOfType([
  ...
  mask: _propTypes['default'].oneOfType([
    _propTypes['default'].string,
  ...
  getInputRef: _propTypes['default'].oneOfType([
    _propTypes['default'].func, // for legacy refs
      ...
      },
      {
        ...
        value: function updateValueIfRequired(prevProps) {
          ...
          if (prevProps !== props) {
            ...
            var formattedValue = (0, _utils.isNil)(props.value)
            ...
            num = ''
              ...
              .concat(
                num
                  ...
                  .replace(new RegExp((0, _utils.escapeRegExp)(decimalSeparator), 'g'), ''),
              );
          } //add negation back
          ...
          if (decimalSeparator === thousandSeparator) {
            throw new Error(
              "\n          Decimal separator can't be same as thousand separator.\n          thousandSeparator: "
                ...
                .concat(decimalSeparator, ' (default value for decimalSeparator is .)\n       '),
            );
          } //validate mask
      ...
      },
      {
        ...
        value: function correctCaretPosition(value, caretPos, direction) {
          ...
          while (
            ...
            (format[caretLeftBound] !== '#' || !(0, _utils.charIsNumber)(value[caretLeftBound]))
          ) {
            caretLeftBound -= 1;
          }
      ...
      },
      {
        ...
        value: function removePrefixAndSuffix(val) {
          ...
          if (!format && val) {
            ...
            val =
              prefix && val.indexOf(prefix) === 0 ? val.substring(prefix.length, val.length) : val; //remove suffix
      ...
      },
      {
        ...
        value: function formatAsNumber(numStr) {
          ...
          if (thousandSeparator) {
            beforeDecimal = (0, _utils.applyThousandSeparator)(
              beforeDecimal,
              thousandSeparator,
              thousandsGroupStyle,
            );
