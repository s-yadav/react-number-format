...
function roundToPrecision(numStr, precision, fillZeroes) {
  ...
  var roundedDecimalParts = currentDecimalPart.length > precision || fillZeroes ? parseFloat('0.' + (currentDecimalPart || '0')).toFixed(precision).split('.') : ['0', currentDecimalPart];
  ...
  _createClass(NumberFormat, [{
    ...
    value: function formatInput(val) {
      ...
      if (format) {
        ...
        var hasDecimalSeparator = formattedValue.indexOf(decimalSeparator) !== -1 || decimalPrecision && fillZeroes;
    ...
    value: function onKeyDown(e) {
      ...
      var _props6 = this.props,
          ...
          fillZeroes = _props6.fillZeroes;
      var key = e.key;

      var numRegex = this.getNumberRegex(false, decimalPrecision !== undefined && fillZeroes);
      var negativeRegex = new RegExp('-');
