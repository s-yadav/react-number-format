...
var propTypes = {
  ...
  convertPersianDigits: _propTypes["default"].bool,
  ...
  _createClass(NumberFormat, [{
    ...
    value: function getNumberRegex(g, ignoreDecimalSeparator) {
      var _this$props = this.props,
          ...
          convertPersianDigits = _this$props.convertPersianDigits;

      var _this$getSeparators2 = this.getSeparators(),
          decimalSeparator = _this$getSeparators2.decimalSeparator;

      return new RegExp('[0-9' + (convertPersianDigits ? "\u06F0-\u06F9" : '') + ']' + (decimalSeparator && decimalScale !== 0 && !ignoreDecimalSeparator && !format ? '|' + (0, _utils.escapeRegExp)(decimalSeparator) : ''), g ? 'g' : undefined);
    }
  }, {
    key: "getSeparators",
    ...
    value: function formatNumString() {
      ...
      var _this$props7 = this.props,
          ...
          convertPersianDigits = _this$props7.convertPersianDigits;
      var formattedValue = convertPersianDigits ? (0, _utils.convertPersianDigitsToEnglish)(numStr) : numStr;
