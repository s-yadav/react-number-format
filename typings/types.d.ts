...
export declare type InputAttributes = Omit<React.InputHTMLAttributes<HTMLInputElement>, 'defaultValue' | 'value'>;
export declare type NumberFormatProps<T = InputAttributes> = NumberFormatPropsBase<T> & Omit<React.InputHTMLAttributes<HTMLInputElement>, keyof T> & Omit<T, keyof NumberFormatPropsBase<unknown> | 'ref'>;
